#!/usr/bin/env python3
"""
Polymarket Pipeline — Live Scanner Dashboard
...
Usage:
    python live_scanner.py              # default 60s interval
    python live_scanner.py 30           # 30s interval
"""
...
def render_header() -> Panel:
    ...
    grid.add_row(
        Text(" POLYMARKET LIVE SCANNER", style="bold bright_green"),
